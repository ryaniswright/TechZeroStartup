...
if __name__ == "__main__":
    ...
    task_table.insert_many([
        ...
        {"time":0.4, "description":"Do something unusual", "list":"the-next-day", "completed":True},
        {"time":0.6, "description":"Do something unusual", "list":"the-day-after-that", "completed":False}
